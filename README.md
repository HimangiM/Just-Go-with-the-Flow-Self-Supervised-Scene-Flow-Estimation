...
#### Building the Project with Docker
  It is possible to build the project with docker using the command
  ```
  docker build .
  ```
  ATTENTION: You may need to change the `CUDA_ARCH` variable in the `Dockerfile`
  to the architecture code of your graphics card.
