...
def get_model(radius, layer, point_cloud, is_training, bn_decay=None, knn=False,
              ...
              rigidity=False, rigidity_radius=0.5, rigidity_nsample=4, rgb=False, interp_alpha=0.5):
    ...
    with tf.variable_scope(tf.get_variable_scope(), reuse=True):
        ...
        print ("Anchored experiment alpha for pc2 hat and pc2", interp_alpha, (1-interp_alpha))
        pred_fb_xyz = interp_alpha * pred_f_copy + (1 - interp_alpha) * grouped_xyz
