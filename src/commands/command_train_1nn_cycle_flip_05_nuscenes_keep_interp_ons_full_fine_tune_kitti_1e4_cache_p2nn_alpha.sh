...
python src/train_1nn_cycle_nuscenes_fine_tune_kitti.py \
    ...
    --log_dir anchored_point/log_train_1nn_cycle_flip_05_nuscenes_keep_interp_ons_fine_tune_kitti_1e4_cache_p2nn_alpha_075_10k \
    --num_point 2048 \
    --batch_size 8 \
    --radius 5 \
    --layer pointnet \
    ...
    --dataset kitti_dataset_self_supervised_cycle_ordered_and_same_corrected \
    --num_frames 2 \
    --max_epoch 10000 \
    --fine_tune \
